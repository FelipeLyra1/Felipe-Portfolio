...
const ProjectsItem = ({img, title}) => {
  return (
    <div className=' relative flex items-center justify-center h-auto w-full shadow-xl rounded-xl shadow-gray-700 group hover:bg-gradient-to-r from-slate-200 to-slate-700 '>
        ...
        <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
            ...
            <a href="https://github.com/FelipeLyra1/Regex-Turorial"></a>
